...
Public Class clsMPReports
    ...
    Private p_oFormxx As frmBillingReport
    ...
    Public Function initReport(ByVal fsReportID As String) As Boolean
        ...
        p_oReport.Load(p_oDriver.AppPath & "\vb.net\Reports\MpPaymentReport.rpt")
        Return True
    ...
    Public Sub New()
        p_oReport = Nothing
        p_oFormxx = New frmBillingReport
    End Sub
End Class
