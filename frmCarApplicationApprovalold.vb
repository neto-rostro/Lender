...
Public Class frmCarApplicationApprovalold

    Private WithEvents poTrans As ggcLRTransaction.LRApplication
    Private pnLoadx As Integer
    Private poControl As Control

    Private Sub frmCarApplicationApproval_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Debug.Print("frmCarApplicationApproval_Activated")
        If pnLoadx = 1 Then
    ...
    Private Sub frmCarApplicationApproval_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmCarApplicationApproval_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Debug.Print("frmCarApplicationApproval_Load")
        If pnLoadx = 0 Then
