...
Public Class frmCarApplicationApproval
    ...
    Private Function isDataComplete() As Boolean
        If p_oTrans.Master("sBranchCd") = "" Then
            MessageBox.Show("Assigned Branch should not be empty!!!", "No entry",
    ...
    Private Sub cmdButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        With p_oTrans
            Select Case lnIndex
                ...
                Case 1 ' Disapprove
                    If p_oTrans.Master("cTranStat") = "4" Then Exit Sub
                    If txtField00.Text <> "" And p_oTrans.Master("cTranStat") <> "1" Then
                        If MsgBox("Do you want to disapprove this application??" & vbCrLf & _
                                  "Further updates will not entertain..", MsgBoxStyle.Information + MsgBoxStyle.OkCancel, "Confirm") = MsgBoxResult.Ok Then
                            If p_oTrans.CancelTransaction Then
                                MsgBox("Application Successfully disapproved!!", vbInformation, "Information")
                ...
                Case 2 ' Confirm
                    If p_oTrans.Master("cTranStat") = "4" Then Exit Sub
                    If txtField00.Text <> "" And p_oTrans.Master("cTranStat") <> "1" Then
                        If isDataComplete() = False Then Exit Sub
                        If MsgBox("Do you want to confirm this application??" & vbCrLf & _
                                  "Further updates will not entertain..", MsgBoxStyle.Information + MsgBoxStyle.OkCancel, "Confirm") = MsgBoxResult.Ok Then
                            If p_oTrans.confirmTransaction Then
                                MsgBox("Application Successfully confirm!!", vbInformation, "Information")
                                Call ClearFields(Me.Panel1)
                                Call ClearFields(Me.Panel2)
                                p_oTrans.OpenTransaction(p_oTrans.Master("sTransNox"))
                                loadTransaction()
                ...
                Case 6 ' save
                    ...
                    If MsgBox("Do you want to save this application??", MsgBoxStyle.Information + MsgBoxStyle.OkCancel, "Confirm") = MsgBoxResult.Ok Then
                        If p_oTrans.SaveTransaction Then
                            ...
                            If MsgBox("Do you want to confirm this application??", MsgBoxStyle.Information + MsgBoxStyle.OkCancel, "Confirm") = MsgBoxResult.Ok Then
                                If p_oTrans.confirmTransaction Then
                                    MsgBox("Application Successfully Confirm!!", vbInformation, "Information")
                                End If
                            End If
            ...
            If Mid(loTxt.Name, 1, 8) = "txtField" Then
                Select Case loIndex
                    Case 80, 81
                        ...
                        End If
                    Case 1
                        loTxt.Text = p_oTrans.getBranch(loTxt.Text, True, False, p_oTrans.Master("sBranchCd"))
                End Select
            End If
                    ...
                    If LCase(Mid(loTxt.Name, 1, 8)) = "txtEmplo" Then
                        With p_oTrans.Detail.means_info
                            Select Case loIndex
                                ...
                                Case 27
                                    If Not IsNumeric(.other_income.nOthrIncm) Then loTxt.Text = CDbl(0)
