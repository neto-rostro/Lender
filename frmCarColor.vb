...
Public Class frmCarColor
    Private Const pxeTableName As String = "Color"
    ...
    Private Function DataComplete() As Boolean
        If txtField00.Text = "" Then
            MessageBox.Show("Please Input Color ID", "No entry",
        ...
        ElseIf txtField01.Text = "" Then
            MessageBox.Show("Please Input Color Name", "No entry",
                                MessageBoxButtons.OK, MessageBoxIcon.Error)
            With txtField01
                .Focus()
                .SelectAll()
    ...
    Private Function NewRecord() As Boolean
        ...
        initButton()
        txtField00.Text = GetNextCode(pxeTableName, "sColorIDx", False, p_oAppDriver.Connection, True, p_oAppDriver.BranchCode)
        Return True
    End Function
                ...
                Select Case p_nEditMode
                    Case xeEditMode.MODE_ADDNEW
                        lsSQL = "INSERT INTO " & pxeTableName & " SET" & _
                                        "  sColorIDx = " & strParm(txtField00.Text) & _
                                        ", sColorNme = " & strParm(txtField01.Text) & _
                    ...
                    Case xeEditMode.MODE_UPDATE
                        ...
                        lsSQL = "UPDATE " & pxeTableName & " SET" & _
                                ...
                                " WHERE sColorIDx = " & strParm(txtField00.Text)
                End Select
...
endwithRoll:
    ...
    Private Function BrowseRecord()
        ...
        lsSQL = "SELECT" & _
                ...
                " FROM " & pxeTableName & _
                " WHERE cRecdStat = 1 " & _
                "AND sColorNme LIKE " & strParm(txtField01.Text + "%")
