...
Public Class frmReceived
    ...
    Private Sub frmReceived_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Debug.Print("frmReceived_Activated")
        If p_TranStatus = "1" Then
            Me.Text = "CarTrade Receiving - Entry"
        End If
        If pnLoadx = 1 Then
    ...
    Private Sub frmReceived_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Debug.Print("frmReceived_Load")
        If pnLoadx = 0 Then
    ...
    Private Sub txtField_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        If e.KeyCode = Keys.F3 Or e.KeyCode = Keys.Enter Then
            ...
            If Mid(loTxt.Name, 1, 8) = "txtSeeks" Then
                Select Case loIndex
                    Case 0, 1
                        If p_oTrans.SearchPayment(poControl.Text, IIf(loIndex = 0, True, False)) = True Then
                            selRow = 0
                            pnRow = 0
                            loadMaster()
                            loadDetail()
    ...
    Private Sub cmdButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Select Case lnIndex
            Case 0 ' Exit
                Me.Dispose()
            Case 5 'Browse
                If p_oTrans.SearchPayment("", False) = True Then
                    selRow = 0
                    pnRow = 0
                    loadMaster()
                    loadDetail()
            ...
            Case 1 ' Received   
                If p_oTrans.Master("sCompnyID") = "" And p_oTrans.Master("sBranchCD") = "" Then
                    ...
                    Exit Sub
                End If
                If MsgBox("Do you want to RECEIVE the transaction", MsgBoxStyle.Information + MsgBoxStyle.OkCancel, "CarTrade Confirmation") = MsgBoxResult.Ok Then
                    If Not p_oTrans.ReceivedPayment() Then
                        MsgBox("Unable to RECEIVE the transaction!", MsgBoxStyle.Information, "CarTrade Entry")
                    End If
                    selRow = 0
                    pnRow = 0
                    MsgBox("Transaction was RECEIVED successfully!", MsgBoxStyle.Information, "CarTrade Entry")
