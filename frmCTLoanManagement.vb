...
Public Class frmCTLoanManagement
    ...
    Private Sub frmCTLoanManagement_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Debug.Print("frmCTLoanManagement_Activated")
        'If p_AccountStatus = "10234" 
        If p_AccountStatus = "-1" Then
            Me.Text = "Car Trade Loan Management System"
        End If
        If pnLoadx = 1 Then
    ...
    Private Sub frmCTLoanManagement_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Debug.Print("frmCTLoanManagement_Load")
        If pnLoadx = 0 Then
        ...
        Try
            If (IsNumeric(input)) Then 'Checks if the input is a number
                If (input.Length <= 2) Then
                    If input = 3 Or input = 6 Or input = 12 Or input = 24 Or input = 36 Or input = 48 Or input = 60 Then
                        Return True
                    End If
                End If
            End If
    ...
    Private Sub cmdButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Select Case lnIndex
            ...
            Case 3 ' Cancel
                If MsgBox("Do you really want to cancel the transaction?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "Car Trade Loan Entry") = MsgBoxResult.Yes Then
                    p_oTrans.InitTransaction()
                    p_oTrans.NewTransaction()
                    Call newRecord()
                End If
                ...
                If entryOK() Then
                    If p_oTrans.SaveTransaction Then
                        ...
                        If MsgBox("Do you want to POST the transaction", MsgBoxStyle.Information + MsgBoxStyle.OkCancel, "Car Trade Entry Confirmation") = MsgBoxResult.Ok Then
                            ...
                            End If
                            MsgBox("Transaction was successfully posted!", MsgBoxStyle.Information, "Car Trade Loan Entry")
            ...
            Case 6
                If p_oTrans.SearchApplication() Then
                    loadMaster()
                    p_nEditMode = xeEditMode.MODE_READY
                    setTextSeeks()
                End If
    ...
    Private Function entryOK() As Boolean
        ...
        ElseIf txtField35.Text = "" Then
            MessageBox.Show("Please have entry in Frame No.", "No entry",
                               MessageBoxButtons.OK, MessageBoxIcon.Error)
            With txtField35
                .Focus()
                .SelectAll()
