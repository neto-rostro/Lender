...
Public Class frmLenderReg
    ...
    Private Sub frmLenderReg_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Debug.Print("frmLenderReg_Activated")
        If p_AccountStatus = "-1" Then
            Me.Text = "Account Receivable History"
        End If
    ...
    Private Sub frmLoanView_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.F3 Or e.KeyCode = Keys.Enter Then
            ...
            If Mid(loTxt.Name, 1, 8) = "txtSeeks" Then
                Select Case loIndex
                    Case 0, 1
                        If p_oTrans.SearchTransaction(loTxt.Text, IIf(loIndex = 0, True, False)) = True Then
                            loadMaster()
                            Call setTextSeeks()
                        End If
                End Select
    ...
    Private Sub frmLenderReg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Debug.Print("frmLenderReg_Load")
        If pnLoadx = 0 Then
